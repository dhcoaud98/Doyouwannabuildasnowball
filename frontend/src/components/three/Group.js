  ...
  return (
    <group rotation={[0.2,0,0]}>
        ...
        <Suspense fallback={null}>
          ...
          {objet1_id == 0 ? <Objet1_01 scale={0.05} position={[0,-26, 20]} rotation={[0,19.5,0]}/> : objet1_id == 1 ? <Objet1_02 scale={0.05} position={[0,-26, 20]} rotation={[0,19.5,0]}/> : objet1_id == 2 ? <Objet1_03 scale={0.05} position={[0,-26, 20]} rotation={[0,19.5,0]}/> : objet1_id == 3 ? <Objet1_04 scale={0.55} position={[0, 35, 0]} rotation={[0,19.5,0]}/> : objet1_id == 4 ? <Objet1_05 scale={0.2} position={[0, 36, 0]}/> : objet1_id == 5 ? <Objet1_06 scale={0.24} position={[-16,-23, 20]} rotation={[0,19.5,0]}/> : objet1_id == 6 ? <Objet1_07 scale={0.25} position={[0, 36, 0]} /> : objet1_id == 7 ? <Objet1_08 scale={0.045} position={[0,-26, 20]} rotation={[0,19.5,0]}/> :  objet1_id == 8 ? <Objet1_09 scale={0.08} position={[0,-26, 20]} rotation={[0,19.5,0]}/> : null}
          ...
          {objet3_id == 0 ? <Objet3_01 scale={0.04} position={[-26,-8 , 12]} rotation={[0,0,0]}/> : objet3_id == 1 ? <Objet3_02 scale={0.08} position={[-16,-26, 20]} rotation={[0,19.5,0]}/> : objet3_id == 2 ? <Objet3_03 scale={0.08} position={[-16,-26, 20]} rotation={[0,19.5,0]}/> : objet3_id == 3 ? <Objet3_04 scale={0.15} position={[-16,-26, 20]} rotation={[0,19.5,0]}/> : objet3_id == 4 ? <Objet3_05 scale={0.075} rotation={[0,19.5,0]} position={[0,-26, 20]}/> : objet3_id == 5 ? <Objet3_06 scale={0.10} position={[-16,-26, 20]} rotation={[0,19.5,0]}/> : objet3_id == 6 ? <Objet3_07 scale={5} position={[0,-26, 20]} rotation={[0,19.5,0]}/> : objet3_id == 7 ? <Objet3_08 scale={5} position={[-16,-26, 20]} rotation={[0,19.5,0]}/> :  objet3_id == 8 ? <Objet3_09 scale={200} position={[-16,-26, 20]} rotation={[0,19.5,0]}/> : null}
