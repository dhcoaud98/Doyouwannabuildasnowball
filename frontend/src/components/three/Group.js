  ...
  return (
    <group>
        ...
        <Suspense fallback={null}>
          ...
          {c_tree_id == 0 ? <C_Tree_01 scale={0.025} position={[0,-26,0]}/> : c_tree_id == 1 ? <C_Tree_02 scale={0.06} position={[0,-26,0]}/> : c_tree_id == 2 ? <C_Tree_03 scale={4} position={[0,-26,0]}/> : c_tree_id == 3 ? <C_Tree_04 scale={0.08} position={[0,-26,0]}/> : c_tree_id == 4 ? <C_Tree_05 scale={0.05} position={[0,-26,0]}/> : c_tree_id == 5 ? <C_Tree_06 scale={0.045} position={[0,-26,0]}/> : c_tree_id == 6 ? <C_Tree_07 scale={0.055} position={[0,-26,0]}/> : c_tree_id == 7 ? <C_Tree_08 scale={0.08} position={[0,-26,0]}/> : <C_Tree_09 scale={0.055} position={[0,-26,0]}/>}
