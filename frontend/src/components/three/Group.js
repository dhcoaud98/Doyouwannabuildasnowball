  ...
  return (
    <group rotation={[0.2,0,0]}>
        ...
        <Suspense fallback={null}>
          ...
          {c_tree_id == 0 ? <C_Tree_01 scale={0.03} position={[0,-26,0]}/> : c_tree_id == 1 ? <C_Tree_02 scale={0.08} position={[0,-26,0]}/> : c_tree_id == 2 ? <C_Tree_03 scale={4} position={[0,-26,0]}/> : c_tree_id == 3 ? <C_Tree_04 scale={0.08} position={[0,-26,0]}/> : c_tree_id == 4 ? <C_Tree_05 scale={0.05} position={[0,-26,0]}/> : c_tree_id == 5 ? <C_Tree_06 scale={0.045} position={[0,-26,0]} rotation={[0,20,0]}/> : c_tree_id == 6 ? <C_Tree_07 scale={0.055} position={[0,-26,0]}/> : c_tree_id == 7 ? <C_Tree_08 scale={0.08} position={[0,-26,0]}/> : <C_Tree_09 scale={0.055} position={[0,-26,0]}/>}
          ...
          {objet3_id == 0 ? <Objet3_01 scale={0.04} position={[-26,-8 , 12]} rotation={[0,0,0]}/> : objet3_id == 1 ? <Objet3_02 scale={0.08} position={[-16,-24, 20]} rotation={[0,19.5,0]}/> : objet3_id == 2 ? <Objet3_03 scale={0.08} position={[-16,-24, 20]} rotation={[0,19.5,0]}/> : objet3_id == 3 ? <Objet3_04 scale={0.35} position={[-16,-24, 20]} rotation={[0,19.5,0]}/> : objet3_id == 4 ? <Objet3_05 scale={0.085} rotation={[0,19.5,0]} position={[-16,-24, 20]}/> : objet3_id == 5 ? <Objet3_06 scale={0.15} position={[-16,-24, 20]} rotation={[0,19.5,0]}/> : objet3_id == 6 ? <Objet3_07 scale={3.5} position={[-16,-18, 20]} rotation={[0,19.5,0]}/> : objet3_id == 7 ? <Objet3_08 scale={3.5} position={[-16,-18, 20]} rotation={[0,19.5,0]}/> :  objet3_id == 8 : null}
