  ...
  return (
    <group rotation={[0.2,0,0]}>
        ...
        <Suspense fallback={null}>
          ...
          {objet3_id == 0 ? <Objet3_01 scale={0.04} position={[-26,-8 , 12]} rotation={[0,0,0]}/> : objet3_id == 1 ? <Objet3_02 scale={0.08} position={[-16,-24, 20]} rotation={[0,19.5,0]}/> : objet3_id == 2 ? <Objet3_03 scale={0.08} position={[-16,-24, 20]} rotation={[0,19.5,0]}/> : objet3_id == 3 ? <Objet3_04 scale={0.35} position={[-16,-24, 20]} rotation={[0,-60.5,0]}/> : objet3_id == 4 ? <Objet3_05 scale={0.085} rotation={[0,-60.5,0]} position={[-16,-24, 20]}/> : objet3_id == 5 ? <Objet3_06 scale={0.15} position={[-16,-24, 20]} rotation={[0,19.5,0]}/> : objet3_id == 6 ? <Objet3_07 scale={3.5} position={[-16,-18, 20]} rotation={[0,19.5,0]}/> : objet3_id == 7 ? <Objet3_08 scale={3.5} position={[-16,-18, 20]} rotation={[0,19.5,0]}/> : null}
