          ...
          <div className={styles.description_box}>
            ...
            <Grid container direction="row" className={styles.description} justifyContent="center">
              <Grid item spacing={3}>
                ...
                <p className={`font-light ${styles.welcome_text} ${styles.green_text}`} style={{fontSize:'1.6rem', margin:0}}>OOO님도 분명 좋아하실거에요</p>
              </Grid>

              <Grid item>
                <p className={`font-bold ${styles.welcome_text} ${styles.red_text}`} style={{fontSize: '1.8rem', margin:0}}>OOO님과 스노우볼을</p>
                <p className={`font-bold ${styles.welcome_text} ${styles.red_text}`} style={{fontSize: '1.8rem', margin:0}}>함께 가지고 싶으신가요?</p>
              </Grid>

              <Grid item container justifyContent="center">
                <ThemeProvider theme={theme}>                  
                  <Button variant="contained" color="primary" className={styles.welcome_button}>
